package com.springbootinpractice.validation;
...
public class PasswordRuleValidator implements ConstraintValidator<Password, String> {
    ...
    public boolean isValid(String password, ConstraintValidatorContext context) {
        ...
        CharacterCharacteristicsRule characterCharacteristicsRule =
                new CharacterCharacteristicsRule(MIN_COMPLEX_RULES, new CharacterRule(EnglishCharacterData.Special, MIN_SPECIAL_CASE_CHARS),
